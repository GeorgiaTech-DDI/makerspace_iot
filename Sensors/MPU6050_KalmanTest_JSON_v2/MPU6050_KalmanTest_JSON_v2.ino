...
//@return void
void floatJsonify(String assetID, int timer, float angleRoll, float anglePitch, float AccX, float AccY, float AccZ) {
...
void loop() {  
  ...
  floatJsonify("Sanding_WoodRoom", timeElapsed, KalmanAngleRoll, KalmanAnglePitch, AccX, AccY, AccZ);
  digitalWrite(13, LOW);
  delay(1000);
